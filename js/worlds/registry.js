...
import { createTunnel } from './tunnel.js?v=512';
import { createSurfer } from './surfer.js?v=512';
import { createOrbit } from './orbit.js?v=512';
import { createBloom } from './bloom.js?v=512';
import { createTrail } from './trail.js?v=512';
import { createSignal } from './signal.js?v=512';
import { createRiver } from './river.js?v=512';
import { createFunhouse } from './funhouse.js?v=512';
import { createLavaLamp } from './lavalamp.js?v=512';
import { createPlasma } from './plasma.js?v=512';
import { createCherryLand } from './cherryland.js?v=512';
import { createSlinky } from './slinky.js?v=512';
import { createBlacktop } from './blacktop.js?v=512';
import { createWaterslide } from './waterslide.js?v=512';
import { createGarden } from './garden.js?v=512';
import { createPaint } from './paint.js?v=512';
import { createComets } from './comets.js?v=512';
