...
import { createTunnel } from './tunnel.js?v=412';
import { createSurfer } from './surfer.js?v=412';
import { createOrbit } from './orbit.js?v=412';
import { createBloom } from './bloom.js?v=412';
import { createTrail } from './trail.js?v=412';
import { createSignal } from './signal.js?v=412';
import { createRiver } from './river.js?v=412';
import { createFunhouse } from './funhouse.js?v=412';
import { createLavaLamp } from './lavalamp.js?v=412';
import { createPlasma } from './plasma.js?v=412';
import { createCherryLand } from './cherryland.js?v=412';
import { createSlinky } from './slinky.js?v=412';
import { createBlacktop } from './blacktop.js?v=412';
import { createWaterslide } from './waterslide.js?v=412';
import { createGarden } from './garden.js?v=412';
import { createPaint } from './paint.js?v=412';
import { createComets } from './comets.js?v=412';
