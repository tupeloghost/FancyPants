...
import { createTunnel } from './tunnel.js?v=173';
import { createSurfer } from './surfer.js?v=173';
import { createOrbit } from './orbit.js?v=173';
import { createBloom } from './bloom.js?v=173';
import { createTrail } from './trail.js?v=173';
import { createSignal } from './signal.js?v=173';
import { createRiver } from './river.js?v=173';
import { createFunhouse } from './funhouse.js?v=173';
import { createLavaLamp } from './lavalamp.js?v=173';
import { createPlasma } from './plasma.js?v=173';
import { createCherryLand } from './cherryland.js?v=173';
import { createSlinky } from './slinky.js?v=173';
import { createBlacktop } from './blacktop.js?v=173';
import { createWaterslide } from './waterslide.js?v=173';
import { createGarden } from './garden.js?v=173';
import { createPaint } from './paint.js?v=173';
...
export const WORLDS = {
  ...
  river:  { pulse: 0.8, rhythm: true, mode: 'DODGE', unit: 'RAMPS',
            rules: 'Steer with the mouse or the arrow keys. Hit the glowing green ramps, miss the dark rocks \u2014 a rock costs you two. Whoever gets the most ramps by the end wins.', goal: 'ride the rapids — click for a surge of speed', label: 'RIVER',  create: createRiver },
