...
import { createTunnel } from './tunnel.js?v=387';
import { createSurfer } from './surfer.js?v=387';
import { createOrbit } from './orbit.js?v=387';
import { createBloom } from './bloom.js?v=387';
import { createTrail } from './trail.js?v=387';
import { createSignal } from './signal.js?v=387';
import { createRiver } from './river.js?v=387';
import { createFunhouse } from './funhouse.js?v=387';
import { createLavaLamp } from './lavalamp.js?v=387';
import { createPlasma } from './plasma.js?v=387';
import { createCherryLand } from './cherryland.js?v=387';
import { createSlinky } from './slinky.js?v=387';
import { createBlacktop } from './blacktop.js?v=387';
import { createWaterslide } from './waterslide.js?v=387';
import { createGarden } from './garden.js?v=387';
import { createPaint } from './paint.js?v=387';
import { createComets } from './comets.js?v=387';
