...
import { createTunnel } from './tunnel.js?v=511';
import { createSurfer } from './surfer.js?v=511';
import { createOrbit } from './orbit.js?v=511';
import { createBloom } from './bloom.js?v=511';
import { createTrail } from './trail.js?v=511';
import { createSignal } from './signal.js?v=511';
import { createRiver } from './river.js?v=511';
import { createFunhouse } from './funhouse.js?v=511';
import { createLavaLamp } from './lavalamp.js?v=511';
import { createPlasma } from './plasma.js?v=511';
import { createCherryLand } from './cherryland.js?v=511';
import { createSlinky } from './slinky.js?v=511';
import { createBlacktop } from './blacktop.js?v=511';
import { createWaterslide } from './waterslide.js?v=511';
import { createGarden } from './garden.js?v=511';
import { createPaint } from './paint.js?v=511';
import { createComets } from './comets.js?v=511';
