...
import { createTunnel } from './tunnel.js?v=625';
import { createSurfer } from './surfer.js?v=625';
import { createOrbit } from './orbit.js?v=625';
import { createBloom } from './bloom.js?v=625';
import { createTrail } from './trail.js?v=625';
import { createSignal } from './signal.js?v=625';
import { createRiver } from './river.js?v=625';
import { createFunhouse } from './funhouse.js?v=625';
import { createLavaLamp } from './lavalamp.js?v=625';
import { createPlasma } from './plasma.js?v=625';
import { createCherryLand } from './cherryland.js?v=625';
import { createSlinky } from './slinky.js?v=625';
import { createBlacktop } from './blacktop.js?v=625';
import { createWaterslide } from './waterslide.js?v=625';
import { createGarden } from './garden.js?v=625';
import { createPaint } from './paint.js?v=625';
import { createComets } from './comets.js?v=625';
