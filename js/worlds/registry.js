...
import { createTunnel } from './tunnel.js?v=486';
import { createSurfer } from './surfer.js?v=486';
import { createOrbit } from './orbit.js?v=486';
import { createBloom } from './bloom.js?v=486';
import { createTrail } from './trail.js?v=486';
import { createSignal } from './signal.js?v=486';
import { createRiver } from './river.js?v=486';
import { createFunhouse } from './funhouse.js?v=486';
import { createLavaLamp } from './lavalamp.js?v=486';
import { createPlasma } from './plasma.js?v=486';
import { createCherryLand } from './cherryland.js?v=486';
import { createSlinky } from './slinky.js?v=486';
import { createBlacktop } from './blacktop.js?v=486';
import { createWaterslide } from './waterslide.js?v=486';
import { createGarden } from './garden.js?v=486';
import { createPaint } from './paint.js?v=486';
import { createComets } from './comets.js?v=486';
