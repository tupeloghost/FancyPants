...
import { createTunnel } from './tunnel.js?v=515';
import { createSurfer } from './surfer.js?v=515';
import { createOrbit } from './orbit.js?v=515';
import { createBloom } from './bloom.js?v=515';
import { createTrail } from './trail.js?v=515';
import { createSignal } from './signal.js?v=515';
import { createRiver } from './river.js?v=515';
import { createFunhouse } from './funhouse.js?v=515';
import { createLavaLamp } from './lavalamp.js?v=515';
import { createPlasma } from './plasma.js?v=515';
import { createCherryLand } from './cherryland.js?v=515';
import { createSlinky } from './slinky.js?v=515';
import { createBlacktop } from './blacktop.js?v=515';
import { createWaterslide } from './waterslide.js?v=515';
import { createGarden } from './garden.js?v=515';
import { createPaint } from './paint.js?v=515';
import { createComets } from './comets.js?v=515';
