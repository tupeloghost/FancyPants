...
import { themePaint } from '../lib/themes.js?v=239';
import { PALETTE } from '../net.js?v=239';
import { TUNE } from '../lib/tune.js?v=239';
import { clear as sfxClear, fanfare as sfxFanfare, thud as sfxThud } from '../lib/sfx.js?v=239';
