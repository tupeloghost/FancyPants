...
import { themePaint } from '../lib/themes.js?v=243';
import { PALETTE } from '../net.js?v=243';
import { TUNE } from '../lib/tune.js?v=243';
import { clear as sfxClear, fanfare as sfxFanfare, thud as sfxThud } from '../lib/sfx.js?v=243';
