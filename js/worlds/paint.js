...
import { themePaint } from '../lib/themes.js?v=480';
import { PALETTE } from '../net.js?v=480';
import { TUNE } from '../lib/tune.js?v=480';
import { clear as sfxClear, fanfare as sfxFanfare, thud as sfxThud } from '../lib/sfx.js?v=480';
